...
export default async function BookingCar({ searchParams }: BookingCarProps) {
	...
	return (
		...
		>
			<div
				className="grid grid-cols-2 gap-5 mt-44 mb-9 sm:px-16 px-6
			...
			>
				...
				<div
					className="flex flex-col justify-start shadow-sm shadow-white rounded-3xl hover:border-primaryColor transition-all overflow-hidden w-full h-[387px]
					hover:scale-[1.02] hover:shadow-primaryColor hover:shadow-md"
				>
					<BookingMapBox />
				</div>
			</div>
